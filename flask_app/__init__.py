...
def create_app(debug=False):
	...
	db.createProject("Pacman AI Maze Search", "pacman.png", "Found optimal cost paths for a Pacman Agent by implementing Dijkstra's algorithm, A*, DFS, BFS, and more!", "https://github.com/rcm5134/PacmanAI", 1,['Python'])
	...
	db.createProject("C++ Sudoku Application", "sudoku.png", 'Collaborated with four developers to create a Sudoku game using C++ and object oriented programming.', "https://gitlab.msu.edu/tranbrya/coeus", 1,["C++"])
